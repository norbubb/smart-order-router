...
export declare class FallbackTenderlySimulator extends Simulator {
    ...
    protected simulateTransaction(fromAddress: string, swapOptions: SwapOptions, swapRoute: SwapRoute, providerConfig?: ProviderConfig): Promise<SwapRoute>;
}
export declare class TenderlySimulator extends Simulator {
    ...
    simulateTransaction(fromAddress: string, swapOptions: SwapOptions, swapRoute: SwapRoute, providerConfig?: ProviderConfig): Promise<SwapRoute>;
