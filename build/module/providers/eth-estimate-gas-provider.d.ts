...
export declare class EthEstimateGasSimulator extends Simulator {
    ...
    protected simulateTransaction(fromAddress: string, swapOptions: SwapOptions, swapRoute: SwapRoute, _providerConfig?: ProviderConfig | undefined): Promise<SwapRoute>;
}
